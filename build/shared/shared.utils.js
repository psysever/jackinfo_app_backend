...
//메인화면 업로드, 아바타 수정
var uploadToS3 = function (file, userId, fileName) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                objectName = "".concat(fileName, "/").concat(userId, "-").concat(Date.now(), "-").concat(filename);
...
var bucketInstance = new aws_sdk_1.default.S3();
var delPhotoS3 = function (fileUrl, folderName) { return __awaiter(void 0, void 0, void 0, function () {
...
var delVideoS3 = function (fileUrl, folderName) { return __awaiter(void 0, void 0, void 0, function () {
    var decodedUrl, filePath, fileName, params;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
