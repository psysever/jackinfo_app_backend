...
exports.default = {
    Mutation: {
        EditPhotoRN: (0, users_utils_1.protectResolver)(function (_, _a, _b) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            console.log(id);
                            return [4 /*yield*/, client_1.default.photoRN.findFirst({
                                    where: {
                                        id: id,
                        ...
                        case 16:
                            fileUrl8 = _c.sent();
                            _c.label = 17;
                        case 17: return [4 /*yield*/, client_1.default.photoRN.update({
                                where: {
                                    id: id,
                                },
